...
Payment.prototype.redpackSend = function(params, callback){
  this._signedQuery(URLS.REDPACK_SEND, params, {
    https:true,
    required: ['mch_billno', 'mch_id','wxappid',"send_name",'re_openid','total_amount','total_num','wishing','client_ip','act_name','remark']
  },callback);
};

Payment.prototype.redpackGroupSend = function(params, callback){
  this._signedQuery(URLS.REDPACK_GROUP_SEND, params, {
    https:true,
    required: ['mch_billno','mch_id','wxappid',"send_name",'re_openid','total_amount','total_num','wishing','amt_type','act_name','remark']
  }, callback);
};

Payment.prototype.redpackQuery = function(params, callback){
  this._signedQuery(URLS.REDPACK_QUERY, params, {
    https:true,
    required: ['mch_billno','mch_id','appid','bill_type']
  }, callback);
};
